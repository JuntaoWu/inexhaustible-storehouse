...
namespace ies {
    ...
    export class SceneCommand extends puremvc.SimpleCommand implements puremvc.ICommand {
        ...
        public static SHOW_CARDS_WINDOW: string = "show_cards_window";
        ...
        initializeNotifier(key: string) {
            ...
            this.facade().registerCommand(SceneCommand.SHOW_CARDS_WINDOW, SceneCommand);
        ...
        public async execute(notification: puremvc.INotification): Promise<any> {
            ...
            switch (notification.getName()) {
                ...
                case SceneCommand.SHOW_CARDS_WINDOW: {
                    appMediator.main.showCardsWindow();
                    break;
                }
